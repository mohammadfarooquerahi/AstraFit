  ...
  try {
    ...
    if (photoCount === 0) {
      await ProgressPhoto.insertMany([
        ...
        { userId: user._id, weekNumber: 1, viewType: 'left', imagePath: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=600&auto=format&fit=crop&q=80', moderationStatus: 'Approved' },
        ...
        { userId: user._id, weekNumber: 4, viewType: 'back', imagePath: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600&auto=format&fit=crop&q=80', moderationStatus: 'Approved' },
      ]);
